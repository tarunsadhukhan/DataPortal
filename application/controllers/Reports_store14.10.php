...
//			$this->session->set_flashdata('message2', 'This is flash message 2');
//			$this->session->set_flashdata('message3', 'This is flash message 3');

//			$this->session->set_userdata('puser_id', $itc);

	//		$this->session->set_storedata('itcode', $itc);
