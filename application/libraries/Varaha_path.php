...
class Varaha
{
    ...
    public function getTenentId(){
        ...
        if($urlParts['path']=='localhost'){                  
        ...
        }else if($urlParts['path'] == 'data.dev.vowerp.com'){
            $servername = "18.130.130.0";
            $username = "console";
            $password = "MeeraN@g10";
            $database = "vowdev";
            $tenentId = "dev.vowerp.com"; 
            $serverIp = "http://devapi.vowerp.com";
        }else if($urlParts['path'] == 'data.qa.vowerp.com'){
            $servername = "35.178.47.156";
            $username = "reportsqa";
            $password = "Reports@123456";
            $database = "vowdev";
            $tenentId = "qa.vowerp.com"; 
            $serverIp = "https://qaapi.vowerp.com";
        }else if($urlParts['path'] == 'data.sls.vowerp.com'){
        ...
        }else if($urlParts['path'] == 'data.sls1.2.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowsls";
        ...
        }else if($urlParts['path'] == 'data.talbot.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowtalbot";
            ...
            $serverIp = "http://tenant1.vowerp.com";
        }else if($urlParts['path'] == 'data.ajm1.2.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowajm";
            ...
            $serverIp = "https://tenant2.vowerp.com";
        }else if($urlParts['path'] == 'data.ajm.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowajm";
            $tenentId = "ajm.vowerp.com"; 
            $serverIp = "https://tenant2.vowerp.com";
        }else if($urlParts['path'] == 'data.sw.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowsworks";
            $tenentId = "sw.vowerp.com"; 
            $serverIp = "https://tenant1.vowerp.com";
        }else if($urlParts['path'] == 'data.capexsw.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowsw_capex_live";
            $tenentId = "capexsw.vowerp.com"; 
            $serverIp = "http://54.79.52.95:8080";
        }else if($urlParts['path'] == 'data.smartworks.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowsls";
            ...
            $serverIp = "https://tenant2.vowerp.com";
        }else if($urlParts['path'] == 'data.cloud.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowcloud";
            ...
            $serverIp = "https://tenant2.vowerp.com";
        }else if($urlParts['path'] == 'data.capexdev.vowerp.com'){
            $servername = "43.205.92.221";
            $username = "reports";
            $password = "Reports@123456";
            $database = "vowsw_capex_live";
            $tenentId = "qa.vowjute.com"; 
            $serverIp = "https://tenant2.vowerp.com";
        }
