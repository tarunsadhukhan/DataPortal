<?php
class All_po_list_model extends CI_Model
{
...
where tpp.company=".$companyId." and  tpp.status not in (4,6,0) and tppd.is_active =1 
...
left join scm_indent_type_master sitm on sitm.indent_type_id =tpp.category 
left join status_master sm on sm.status_id =tpp.status 
where tpp.company=".$pers['company']." and  tpp.status not in (4,6,0) and tppd.is_active =1 
