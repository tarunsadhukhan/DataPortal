<?php
class Outstanding_indent_model extends CI_Model
{
...
from
	...
	from
		...
		WHERE
			...
			and l.is_active = 1
			and h.indent_status not in (4, 6, 0, 5) ) g
	group by
		indent_no,
		Indentdate,
		...
		uom_code,
		indent_qty,
		ifnull(cancelled_qty, 0) ) g ) h
		where qty_outstanding_for_receive>0
order by
indentdate,
indent_no ASC
";
