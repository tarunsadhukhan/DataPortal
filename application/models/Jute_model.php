<?php
class Jute_model extends CI_Model
{

	// var $table = 'JUTE_ISSUE_REPORT';	
	// var $column_order = array(null, 'company_id','Issue Date','MrNo','Quality', 'Godown', 'Bale Loose', 'Yarn Type', 'rate', 'Issue Value', 'Quantity', 'Total Weight'); //set column field database for datatable orderable
	// var $column_search = array( 'company_id','Issue Date','MrNo','Quality', 'Godown', 'Bale Loose', 'Yarn Type', 'rate', 'Issue Value', 'Quantity', 'Total Weight'); //set column field database for datatable searchable 
	// var $order = array('MrNo' => 'desc'); // default order 
