    ...
    <style>
        ...
        /* === HEADER STYLING === */
         ...
         /* Right-align numeric columns in headers */
         #attPrepTable thead th:nth-child(8),
         #attPrepTable thead th:nth-child(9),
         #attPrepTable thead th:nth-child(10) {
        ...
        /* === BODY CELL STYLING === */
         ...
         #attPrepTable tbody td:nth-child(8),
         #attPrepTable tbody td:nth-child(9),
         #attPrepTable tbody td:nth-child(10) {
            text-align: right !important;
            padding-right: 12px !important;
         }
        ...
        <div id="attPrepModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" style="display:flex;flex-wrap:wrap;gap:5px;">
                        <div class="col-12 col-sm-2">
                            <label for="atp_mc_nos">MC Nos</label>
                            <input class="form-control form-control-rounded" id="atp_mc_nos" name="atp_mc_nos" type="text">
                        </div>
                        <div class="col-12 col-sm-2">
