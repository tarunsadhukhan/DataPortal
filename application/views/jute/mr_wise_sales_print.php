    ...
    <tbody>
        <?php
            if($res){
                foreach($res as $row){
                    echo '<tr>';
                    echo '<td class="thtop thleft">'.$row->Year_Month.'</td>';
                    ...
                    echo '<td class="thtop thleft">'.$row->Receipt_Wt_QNT.'</td>';
                    echo '<td class="thtop thleft">'.$row->Issued_Wt_QNT.'</td>';
                    echo '<td class="thtop thleft">'.$row->Sold_Wt_QNT.'</td>';
                    echo '</tr>';
