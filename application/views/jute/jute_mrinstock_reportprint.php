...
<table cellpadding=0 cellspacing=0 width="100%">
        ...
        <?php
            if($res){
                foreach($res as $row){
                    ...
                    echo '<td class="thtop thleft">'.$row->Bales_Stock.'</td>';
                    ...
                    echo '<td class="thtop thleft">'.$row->Drums_Stock.'</td>';
                    ...
                    echo '<td class="thtop thleft">'.$row->Stock_Qnt.'</td>';
                    echo '</tr>';
    ...
    <tfoot>
        <tr>
            <th colspan="20" class="thtop thleft thright thbottom">&nbsp;</th>
        </tr>
    </tfoot>
</table>
<script>
