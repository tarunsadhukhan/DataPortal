        ...
        <?php
            if($res){
                foreach($res as $row){
                    ...
                    echo '<td class="thtop thleft">'.$row->Total_MR.'</td>';
                    echo '<td class="thtop thleft">'.$row->Total_Pass.'</td>';
                    echo '<td class="thtop thleft">'.$row->Total_Claim.'</td>';
                    echo '<td class="thtop thleft">'.$row->Pass_percent.'</td>';                    
                    echo '<td class="thtop thleft">'.$row->Claim_percent.'</td>';
                    echo '</tr>';
