...
<?php
        ...
        <div id="myModal" class="modal">
            ...
            <h1 class="modal-title" id="exampleModalLabel">Occupation Wise Hands Details</h1>
                <button type="button" id="closebtns" onclick="closeModal()" class="close" data-dismiss="modal" 
                aria-label="Close">
                </button>
            </div>
